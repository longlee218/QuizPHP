<?php
include_once './MVC/Views/navbar_student.php' ?>
                ...
                <form class="form">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link ab active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true"><h4>Home</h4></a>
                            <a class="nav-item nav-link ab text-dark" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false"><h4>Địa chỉ</h4></a>
                            <a class="nav-item nav-link ab text-dark" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false"><h4>Tài khoản</h4></a>
                        </div>
                    </nav>
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                            <br>
                            Tài khoản này được tạo bởi là của học sinh.
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
                                <br>
    ...
    <script>
        ...
        $('#school_name').val(user_info['school_name']);
        $('#class_name').val(user_info['class_name']);
        var value_gender = user_info['gender'];
